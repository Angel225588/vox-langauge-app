...
- **Self-directed learning** - Users choose topics, not forced curriculum
- **Immediate action** - Jump into practice within seconds of opening app

## Lesson Flow Architecture (Core Feature)

### Time-Based Dynamic Lessons

Users select lesson duration: **[10 min]** or **[20 min]**

The flow automatically adapts to fill the selected time with a complete learning cycle:

```
User selects: [10 min] or [20 min]
         ↓
  Automated Flow (fills time):
┌─────────────────────────────────────┐
│ 1. Flashcards (3-card cycle)        │
│    └─ Image+Audio → Listen+Type →   │
│       Speak+Record                  │
├─────────────────────────────────────┤
│ 2. Games (tap-to-match, etc.)       │
│    └─ Practice vocabulary learned   │
├─────────────────────────────────────┤
│ 3. Reading Practice                 │
│    └─ Story with highlighted vocab  │
├─────────────────────────────────────┤
│ 4. Speaking Practice                │
│    └─ Record yourself reading       │
├─────────────────────────────────────┤
│ 5. AI Agent Conversation (2-3 min)  │
│    └─ Chat using what you learned   │
└─────────────────────────────────────┘
         ↓
  Complete! +Points, +Streak
```

### Flow Components (Build Priority Order)

1. **Flashcards** - Foundation of learning
   - Learning card: Image + text + phonetics + audio
   - Listening card: Audio → type what you hear
   - Speaking card: See word → record pronunciation
   - SM-2 spaced repetition for optimal review timing

2. **Games** - Immediate reinforcement
...
3. **Reading** - Comprehension practice
   - Teleprompter with highlighted vocabulary
   - Click word → definition (offline)
   - Double-click → phrase meaning
   - AI-generated personalized stories

4. **Speaking/Recording** - Production practice
   - Record while reading or describing
   - Playback review
   - AI pronunciation feedback (when online)
   - Saved locally, uploaded when connected

5. **AI Agent Conversation** - Interactive application
...
Each lesson learns from the previous:
- Words user struggled with → emphasized in next lesson
- User preferences → content personalization
- Success rate → difficulty adjustment
- Time taken → pacing optimization

If user completes a 10-min lesson and starts another immediately, the new lesson:
- Incorporates feedback from previous session
- Adjusts difficulty based on performance
- Avoids repetition of mastered content
- Focuses on areas needing practice

## Strategic Decisions

These key decisions shape the entire app experience:

✅ **First Experience**: Jump straight into 10-minute lesson (immediate value, no waiting)
✅ **Learning Path**: Categories-first, self-directed (users choose topics, not forced curriculum)
✅ **Level Assessment**: 5-10 minutes, hybrid approach (visual + audio + speaking tests)
✅ **Gamification Timing**: Show points after first lesson completion (reward accomplishment)
✅ **Lesson Durations**: Start with 10 & 20 min options (covers most use cases)
✅ **Offline Priority**: Flashcards, games, reading, recording all work offline (only AI chat needs internet)
✅ **Adaptive Content**: Each lesson influences the next (continuous improvement)
✅ **Categories Focus**: Verbs (with phrasal verbs), Objects, Expressions (personalized to user context)

## App Navigation Structure

Bottom tabs provide quick access to all major features:
...
│    └─ Verbs & Phrasal Verbs        │
│    └─ Objects & Items              │
│    └─ Expressions (daily + custom) │
│    └─ Situations (restaurant, etc.)│
│                                    │
│ 👥 Community                        │
│    └─ Public recordings            │
│    └─ Feedback & comments          │
...
**Primary Path**: Home → Browse Categories → Select Topic → Start 10-min Lesson
**Alternative**: Home → Continue Last Lesson
**Practice**: Exercises tab for standalone games (build confidence)
